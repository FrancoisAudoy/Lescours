...
%M11= sort(M11, 2) % chaque colonne est triée

%M11 =sort(M11, 1) % chaque ligne est triée
...
%x = [-10 10]
%y = droite2DVD(x,vd,p)
%figure('Name','Droite2DVD')
%plot(x, y)

%y = droite2DNorm(x, vn, p)
%figure('Name','Droite2DNorm')
%plot(x,y)
